...
public class CustomPOMTestScript2 {
	...
	public static void main(String[] args) {
		...
		orders.selectVisibleOptionPaymentMethodDropdown("PayPal Commerce");
		orders.getOptionsPaymentMethodDropdown();
		orders.clickSearchBtn();
